...
void layerConvDWBNRelu4(
  ...
  if(pi_core_id()==0)
  {
    ...
    copy_k.loc = (uint32_t) l1_buffer + 5048;
    ...
    copy_lambda.loc = (uint32_t) l1_buffer + 5084;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    // transfer of next input tile in double buffering
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        if(pi_core_id()==0)
        {
          ...
          copy_k.loc = (uint32_t) l1_buffer + 5048 + db_act;
          pi_cl_dma_memcpy(&copy_k);   
          copy_lambda.dir = PI_CL_DMA_DIR_EXT2LOC;
          copy_lambda.merge = 0;
          ...
          copy_lambda.loc = (uint32_t) l1_buffer + 5084 + db_act;
          pi_cl_dma_memcpy(&copy_lambda);      
        }
      }
    }
    ...
    k = (int64_t *) (l1_buffer + 5048 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 5084 + exec_db_act);
