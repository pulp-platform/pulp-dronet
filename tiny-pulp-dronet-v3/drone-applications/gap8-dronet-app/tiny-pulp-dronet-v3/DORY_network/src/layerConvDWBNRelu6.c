...
void layerConvDWBNRelu6(
  ...
  if(pi_core_id()==0)
  {
    ...
    copy_k.loc = (uint32_t) l1_buffer + 3224;
    ...
    copy_lambda.loc = (uint32_t) l1_buffer + 3260;
  ...
  l2_W, // ext
  (l1_buffer + 3184) + 0, // loc offset caused by size of tile_x*2 (double_buffer) and tile_y*2 (double buffer)
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    // transfer of next input tile in double buffering
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        if(pi_core_id()==0)
        {
          ...
          copy_k.loc = (uint32_t) l1_buffer + 3224 + db_act;
          pi_cl_dma_memcpy(&copy_k);   
          copy_lambda.dir = PI_CL_DMA_DIR_EXT2LOC;
          copy_lambda.merge = 0;
          ...
          copy_lambda.loc = (uint32_t) l1_buffer + 3260 + db_act;
          pi_cl_dma_memcpy(&copy_lambda);      
        }
      }
    }
    ...
    k = (int64_t *) (l1_buffer + 3224 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 3260 + exec_db_act);
    W = (char *) (l1_buffer + 3184 + exec_db_W);
    ...
    {  
      ...
      {                                       
        ...
        dory_dma_memcpy_3d_custom_blocking(
        dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 13, 13, 4, 13, 4, 0, 0, 0, 0, 0, 0, 8), // ext
